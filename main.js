document.addEventListener('DOMContentLoaded', () => {
    ...
    function handleWeatherRequest() {
        console.log("handleWeatherRequest function called");
    ...
    function handleReturn() {
        console.log("handleReturn function called");
    ...
    function showElementsWithFadeIn(selectors) {
    ...
    function fadeOutElements(selectors, callback) {
        selectors.forEach(selector => {
            const element = document.querySelector(selector);
    ...
    function startWeatherUpdate(city, interval) {
